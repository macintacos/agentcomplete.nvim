...
---@field scroll_down string|false Key that scrolls the pane down a line; `false` leaves it alone.
---@field scroll_up string|false Key that scrolls it back up; `false` leaves it alone.
